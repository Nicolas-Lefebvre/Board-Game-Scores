...
function Cgu() {
  return (
    <div>
      ...
      <h4>En vigueur au 13/01/2023</h4>
        <div>
          <p>
            ...
            www.boardgamescores.fr se réserve le droit de modifier unilatéralement et à tout moment le contenu
            des présentes CGU.
            </p>
        </div>
        <div>
          <h3>Article 1 : Les mentions légales</h3>
            <p>
              L’édition et la direction de la publication du site www.boardgamescores.fr est assurée par Nicolas
              Lefevre, domicilié _______________.
              Numéro de téléphone est _______________
              Adresse e-mail _______________.
              L'hébergeur du site www.boardgamescores.fr est la société _______________, dont le siège social
        ...
        <div>
          <h3>ARTICLE 2 : Accès au site</h3>
            <p>
              Le site www.boardgamescores.fr permet à l'Utilisateur un accès gratuit aux services suivants :
              Le site internet propose les services suivants :
              - Enregistrement des statistiques lors de parties de jeux de sociétés et plus,
              ...
              la responsabilité de www.boardgamescores.fr. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir
        ...
        <div>
          <h3>ARTICLE 5 : Responsabilité</h3>
            <p>
              Les sources des informations diffusées sur le site www.boardgamescores.fr sont réputées fiables mais
              ...
              Malgré des mises à jour régulières, le site www.boardgamescores.fr ne peut être tenu responsable de
              ...
              Le site www.boardgamescores.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient
        ...
        <div>
          <h3>ARTICLE 6 : Liens hypertextes</h3>
            <p>
              ...
              liens, il sortira du site www.boardgamescores.fr. Ce dernier n’a pas de contrôle sur les pages web sur
        ...
        <div>
          <h3>ARTICLE 7 : Cookies</h3>
            <p>
              ...
              www.boardgamescores.fr. Les cookies ne contiennent pas d’information personnelle et ne peuvent
              ...
              restent.
              L’information contenue dans les cookies est utilisée pour améliorer le site www.boardgamescores.fr.
